...
public interface TConSupplierapplyMapper extends BaseMapper<TConSupplierapply> {
    ...
    void insertAcceptInfo(String easid, String acceptTime, String finalBillType, String acceptType, int i);
    ...
    void updateAcceptInfo(String easid, String acceptTime, int i, String message);

    String selectEditUrl();

    void insertALLAcceptInfo(String easid, String acceptTime, String finalBillType, String acceptType, int state, String message);

    String selectEASSessionId();

    void updateSessionId();

    void insertSessionId(String sessionId);
